...
public class OrderView extends JPanel {
    ...
    private void initComponents() {
        ...
        dpOrderDate.setBackground(new Color(245, 245, 255));
        dpOrderDate.getCalendarButton().setBackground(new Color(200, 180, 230));
        dpOrderDate.getCalendarButton().setForeground(Color.BLACK);
        ...
        btnExport.setBackground(new Color(200, 180, 230));
        ...
        tbExport.setBackground(new Color(245, 245, 255));
        tbExport.getTableHeader().setBackground(new Color(200, 180, 230));
        tbExport.getTableHeader().setForeground(Color.BLACK);
