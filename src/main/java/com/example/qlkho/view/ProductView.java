...
public class ProductView extends JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        
        JPanel headerPanel = createHeaderPanel();
        add(headerPanel, BorderLayout.NORTH);
        
        JPanel mainPanel = new JPanel(new GridBagLayout());
        mainPanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        ...
        formPanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        ...
        buttonPanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        ...
        tablePanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        GridBagConstraints tableGbc = new GridBagConstraints();

        JPanel searchPanel = new JPanel(new GridBagLayout());
        searchPanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        ...
        filterPanel.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        ...
        rNone.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        rCategory.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
        rSupplie.setBackground(new Color(248, 245, 255)); // Màu nền tím nhạt
    ...
    private JPanel createHeaderPanel() {
        final Color PRIMARY_COLOR = new Color(138, 87, 195); // Màu tím đậm cho header
